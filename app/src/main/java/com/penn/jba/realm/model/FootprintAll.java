...
import static com.penn.jba.R.string.sb_reply_to_me;
...
public class FootprintAll extends RealmObject {
    ...
    public String getContent() {
        if (type == 8) {
            ...
            String nicknameA = ppFromString(body, "relatedUsers.0.nickname").getAsString();
            String nicknameB = ppFromString(body, "relatedUsers.1.nickname").getAsString();
            String beFriend = ppFromString(body, "detail.beFriend", "int").getAsInt() == 1 ? PPApplication.getContext().getString(R.string.be_friend) : "";
            if (idA == PPHelper.currentUserId) {
    ...
    public ArrayList<String> getImages() {
        ...
        if (type == 3) {
            JsonArray pics = PPHelper.ppFromString(body, "detail.pics").getAsJsonArray();
